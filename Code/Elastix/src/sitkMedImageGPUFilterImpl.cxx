...
bool MedImageGPUFilter::MedImageGPUFilterImpl
::IsGPUEnabled()
{
  bool bEnabled = false;
...
::Resample( const Image& inputImage, const std::vector<float> outputSpacing)
{
  ...
  {
    std::cout << "Input Image Dimension or Spacing not Match," << " Spacing size  " << outputSpacing.size() << std::endl;
    return outputImage;
  }
